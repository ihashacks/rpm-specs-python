...
BuildArch:     noarch
BuildRequires: python27-devel >= 2.4
...
perl -pi -e 's|python|%{__python}|' doc/Makefile
...
do
    mv $f ${f}2.7
    j=`basename $f`
    ln -s %{_bindir}/${j}2.7 %{buildroot}%{pybindir}/$j
done
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 1.1.3-1
