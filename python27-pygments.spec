...
BuildArch:      noarch
BuildRequires:  python27-devel >= 2.4, python27-setuptools, python27-nose
%if 0%{?with_python3}
...
Requires:       python27-setuptools, python27-imaging
%if 0%{?with_python26}
...
mv pygmentize.1 $RPM_BUILD_ROOT%{_mandir}/man1/pygmentize2.7.1
mv build html
mv src reST
popd
mkdir -p %{buildroot}%{pybindir}
mv %{buildroot}%{_bindir}/pygmentize %{buildroot}%{_bindir}/pygmentize2.7
ln -s %{_bindir}/pygmentize2.7 %{buildroot}%{pybindir}/pygmentize
...
%{_bindir}/pygmentize*
%{pybindir}/pygmentize
%lang(en) %{_mandir}/man1/pygmentize*
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 1.4-4
