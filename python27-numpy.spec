...
BuildRequires:  python27-devel lapack-devel python27-setuptools gcc-gfortran atlas-devel python27-nose
...
Provides:       f2py27 = %{version}-%{release}
Obsoletes:      f2py27 <= 2.45.241_1927
...
rm -rf docs-f2py ; mv %{buildroot}%{python3_sitearch}/numpy/f2py/docs docs-f2py
mv -f %{buildroot}%{python3_sitearch}/numpy/f2py/f2py.1 f2py.1
install -D -p -m 0644 f2py.1 %{buildroot}%{_mandir}/man1/f2py3.1
...
install -D -p -m 0644 f2py.1 %{buildroot}%{_mandir}/man1/f2py27.1
pushd %{buildroot}%{_bindir} &> /dev/null
# symlink for anyone who was using f2py.numpy
ln -s f2py2.7 f2py.numpy2.7
ln -s f2py2.7 f2py.numpy27
ln -s f2py2.7 f2py27
popd &> /dev/null
mkdir -p %{buildroot}%{pybindir}
ln -s %{_bindir}/f2py2.7 %{buildroot}%{pybindir}/f2py
ln -s %{_bindir}/f2py2.7 %{buildroot}%{pybindir}/f2py.numpy

#symlink for includes, BZ 185079
mkdir -p %{buildroot}/usr/include
ln -s %{python_sitearch}/numpy/core/include/numpy/ %{buildroot}/usr/include/numpy27
...
%dir %{python_sitearch}/%{rname}
%{python_sitearch}/%{rname}/*.py*
%{python_sitearch}/%{rname}/core
%{python_sitearch}/%{rname}/distutils
%{python_sitearch}/%{rname}/doc
%{python_sitearch}/%{rname}/fft
%{python_sitearch}/%{rname}/lib
%{python_sitearch}/%{rname}/linalg
%{python_sitearch}/%{rname}/ma
%{python_sitearch}/%{rname}/numarray
%{python_sitearch}/%{rname}/oldnumeric
%{python_sitearch}/%{rname}/random
%{python_sitearch}/%{rname}/testing
%{python_sitearch}/%{rname}/tests
%{python_sitearch}/%{rname}/compat
%{python_sitearch}/%{rname}/matrixlib
%{python_sitearch}/%{rname}/polynomial
%{python_sitearch}/%{rname}-*.egg-info
%{_includedir}/numpy27
...
%{_bindir}/f2py2*
%{_bindir}/f2py.numpy*
%{python_sitearch}/%{rname}/f2py
%{pybindir}/f2py*

%if 0%{?with_python3}
%files -n python3-numpy
%doc doc/cython LICENSE.txt README.txt THANKS.txt DEV_README.txt COMPATIBILITY site.cfg.example
%{python3_sitearch}/%{rname}/__pycache__
%dir %{python3_sitearch}/%{rname}
%{python3_sitearch}/%{rname}/*.py*
%{python3_sitearch}/%{rname}/core
%{python3_sitearch}/%{rname}/distutils
%{python3_sitearch}/%{rname}/doc
%{python3_sitearch}/%{rname}/fft
%{python3_sitearch}/%{rname}/lib
%{python3_sitearch}/%{rname}/linalg
%{python3_sitearch}/%{rname}/ma
%{python3_sitearch}/%{rname}/numarray
%{python3_sitearch}/%{rname}/oldnumeric
%{python3_sitearch}/%{rname}/random
%{python3_sitearch}/%{rname}/testing
%{python3_sitearch}/%{rname}/tests
%{python3_sitearch}/%{rname}/compat
%{python3_sitearch}/%{rname}/matrixlib
%{python3_sitearch}/%{rname}/polynomial
%{python3_sitearch}/%{rname}-*.egg-info

%files -n python3-numpy-f2py
%doc docs-f2py
%{_bindir}/f2py3
%{python3_sitearch}/%{rname}/f2py
%endif # with_python3
