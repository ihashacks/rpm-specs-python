...
BuildRequires: pycairo27-devel >= %{pycairo_version}
BuildRequires: pygobject227-devel >= %{pygobject2_version}
BuildRequires: python27-devel >= %{python2_version}
...
Requires: pkgconfig
Requires: pycairo27-devel
Requires: pygobject227-devel
...
mkdir -p $RPM_BUILD_ROOT%{pybindir}
mv $RPM_BUILD_ROOT%{_bindir}/pygtk-demo $RPM_BUILD_ROOT%{_bindir}/pygtk-demo27
ln -s %{_bindir}/pygtk-demo27 $RPM_BUILD_ROOT%{pybindir}/pygtk-demo
perl -pi -e 's|"pygtk"|"pygtk27"|' $RPM_BUILD_ROOT%{_bindir}/pygtk-demo27
mv $RPM_BUILD_ROOT%{_libdir}/pygtk $RPM_BUILD_ROOT%{_libdir}/pygtk27
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 2.16.0-3.el6
