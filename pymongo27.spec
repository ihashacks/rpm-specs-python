...
Requires:       python27-bson = %{version}-%{release}
...
%package -n python27-bson
Summary:        Python bson library
Group:          Development/Libraries

%description -n python27-bson
...
chmod 755 %{buildroot}%{python_sitearch}/pymongo/_cmessage.so
