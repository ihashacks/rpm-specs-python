...
BuildRequires:  python27-coverage >= 3.4-1
...
mv %{buildroot}%{_mandir}/man1/nosetests.1 %{buildroot}%{_mandir}/man1/nosetests27.1

%if 0%{?with_docs}
pushd doc
make SPHINXBUILD=sphinx-build2.7 html
...
mv %{buildroot}/%{_bindir}/nosetests %{buildroot}%{pybindir}
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 1.3.0-1
