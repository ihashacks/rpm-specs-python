...
mkdir -p $RPM_BUILD_ROOT%{pylibdir}/bin
mv $RPM_BUILD_ROOT/usr/bin/cython $RPM_BUILD_ROOT/usr/bin/cython27
ln -s /usr/bin/cython27 $RPM_BUILD_ROOT%{pylibdir}/bin/cython
mv $RPM_BUILD_ROOT/usr/bin/cygdb $RPM_BUILD_ROOT/usr/bin/cygdb27
ln -s /usr/bin/cygdb27 $RPM_BUILD_ROOT%{pylibdir}/bin/cygdb
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 0.18-1
