...
Patch1:        %{oname}-lib64.patch
Patch2:        %{oname}-giftrans.patch
Patch3:        %{oname}-1.1.6-sane-types.patch
Patch4:        %{oname}-shebang.patch

# buffer overflow patch, bz 703212
Patch5:        %{oname}-buffer.patch
URL:           http://www.pythonware.com/products/pil/
BuildRoot:     %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)

BuildRequires: python27-devel, libjpeg-devel, zlib-devel, freetype-devel
...
Requires: %{name} = %{version}-%{release}, python27-devel
...
%changelog
* Thu Sep 18 2014 Brandon Pierce <brandon@ihashacks.com - 1.1.7-6
